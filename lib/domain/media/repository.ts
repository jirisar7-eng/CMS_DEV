...
const INITIAL_MEDIA_FIXTURES: MediaAsset[] = [
  {
    ...
    metadata: {
      ...
      caption: 'Fotografie moderní centrály Synthesis',
      author: 'Jan Novák',
  ...
  },
  {
    ...
    metadata: {
      ...
      author: 'Design Studio Synthesis',
  ...
  },
  {
    ...
    status: 'ready',
    metadata: {
      title: 'Tým inženýrů Synthesis',
      altText: 'Členové vývojového týmu Synthesis při práci v moderní kanceláři',
      description: 'Skupinová fotografie pro sekci O nás a kariérní stránku.',
      author: 'Petra Svobodová',
      tags: ['tým', 'o-nas', 'kancelář', 'lidé'],
    },
    projectId: 'synthesis-main',
