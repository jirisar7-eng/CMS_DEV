...
const INITIAL_PAGES_FIXTURE: PageDetail[] = [
    ...
    content: {
      ...
      blocks: [
        ...
        },
        {
          ...
          order: 1,
          data: {
            text: 'Synthesis je moderní digitální ekosystém navržený s důrazem na bezpečnost, stabilitu a škálovatelnost.',
          },
        },
      ],
    },
  ...
  },
  {
    ...
    locale: 'cs-CZ',
    order: 1,
    description: 'Představení klíčových architektů a vývojářů.',
    visibility: 'Veřejná',
    content: {
      version: 1,
      schemaVersion: 'syn-block-v1',
      blocks: [
        ...
        },
        {
          ...
          order: 1,
          data: {
            text: 'Tým odborníků zastřešující architekturu, bezpečnost a frontendové rozhraní.',
          },
        },
      ],
    },
    templateId: 'tpl-team',
    seo: {
      metaTitle: 'Náš tým | Synthesis CMS',
      metaDescription: 'Lidé stojící za platformou Synthesis.',
      canonicalUrl: 'https://synthesis.local/o-projektu/tym',
      noIndex: false,
      ogImage: '',
    },
    navigation: {
